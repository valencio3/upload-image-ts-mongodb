...
const MIME_TYPE_VALIDO = ['image/png','image/jpeg','image/jpg']
export class ArquivoController {
  ...
  private _ehUmaExtensaoValida(objArquivo: any) : boolean {
     return (
        MIME_TYPE_VALIDO.includes(objArquivo['mimetype'])
     )
  }
  ...
  realizarUpload (objArquivo: any): Promise<ObjectId> {
    return new Promise((resolve, reject) => {
      if (this._ehUmObjetoDeArquivoValido(objArquivo) && this._ehUmaExtensaoValida(objArquivo)) {
